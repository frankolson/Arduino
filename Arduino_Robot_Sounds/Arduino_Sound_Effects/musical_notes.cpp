...
musical_notes::musical_notes(int speakerPin){
	// Setup the speaker pin to output
	pinMode(speakerPin, OUTPUT);
	_speakerPin = speakerPin;
}

void musical_notes::beep (int _speakerPin, float _noteFrequency, long _noteDuration)
{    
  int x;
  // Convert the frequency to microseconds
  float microsecondsPerWave = 1000000/_noteFrequency;
  // Calculate how many HIGH/LOW cycles there are per millisecond
  float millisecondsPerCycle = 1000/(microsecondsPerWave * 2);
  // Multiply noteDuration * number or cycles per millisecond
  float loopTime = _noteDuration * millisecondsPerCycle;
...
void musical_notes::scale() 
{    
          beep(_speakerPin, note_C7,500); //C: play the note C for 500ms 
          beep(_speakerPin, note_D7,500); //D 
          beep(_speakerPin, note_E7,500); //E 
          beep(_speakerPin, note_F7,500); //F 
          beep(_speakerPin, note_G7,500); //G 
          beep(_speakerPin, note_A7,500); //A 
          beep(_speakerPin, note_B7,500); //B 
          beep(_speakerPin, note_C8,500); //C 
}  

void musical_notes::r2D2(){
          beep(_speakerPin, note_A7,100); //A 
          beep(_speakerPin, note_G7,100); //G 
          beep(_speakerPin, note_E7,100); //E 
          beep(_speakerPin, note_C7,100); //C
          beep(_speakerPin, note_D7,100); //D 
          beep(_speakerPin, note_B7,100); //B 
          beep(_speakerPin, note_F7,100); //F 
          beep(_speakerPin, note_C8,100); //C 
          beep(_speakerPin, note_A7,100); //A 
          beep(_speakerPin, note_G7,100); //G 
          beep(_speakerPin, note_E7,100); //E 
          beep(_speakerPin, note_C7,100); //C
...
void musical_notes::closeEncounters() {
          beep(_speakerPin, note_Bb5,300); //B b
          delay(50);
          beep(_speakerPin, note_C6,300); //C
          delay(50);
          beep(_speakerPin, note_Ab5,300); //A b
          delay(50);
          beep(_speakerPin, note_Ab4,300); //A b
          delay(50);
          beep(_speakerPin, note_Eb5,500); //E b   
          delay(500);     
          
          beep(_speakerPin, note_Bb4,300); //B b
          delay(100);
          beep(_speakerPin, note_C5,300); //C
          delay(100);
          beep(_speakerPin, note_Ab4,300); //A b
          delay(100);
          beep(_speakerPin, note_Ab3,300); //A b
          delay(100);
          beep(_speakerPin, note_Eb4,500); //E b   
          delay(500);  
          
          beep(_speakerPin, note_Bb3,300); //B b
          delay(200);
          beep(_speakerPin, note_C4,300); //C
          delay(200);
          beep(_speakerPin, note_Ab3,300); //A b
          delay(500);
          beep(_speakerPin, note_Ab2,300); //A b
          delay(550);
          beep(_speakerPin, note_Eb3,500); //E b      
}

void musical_notes::ariel() {

          beep(_speakerPin, note_C6,300); //C
          delay(50);
          beep(_speakerPin, note_D6,300); //D
          delay(50);
          beep(_speakerPin, note_Eb6,600); //D#
          delay(250);
          
          beep(_speakerPin, note_D6,300); //D
          delay(50);
          beep(_speakerPin, note_Eb6,300); //D#
          delay(50);
          beep(_speakerPin, note_F6,600); //F
          delay(250);
          ...
          beep(_speakerPin, note_D6,300); //D
          delay(50);
          beep(_speakerPin, note_Eb6,500); //D#
          delay(50);          
          beep(_speakerPin, note_D6,300); //D
          delay(50);
          beep(_speakerPin, note_Eb6,300); //D#
...
void musical_notes::laugh2() {
          beep(_speakerPin, note_C6,200); //C
          beep(_speakerPin, note_E6,200); //E  
          beep(_speakerPin, note_G6,200); //G 
          beep(_speakerPin, note_C7,200); //C 
          beep(_speakerPin, note_C6,200); //C
          delay(50);
          beep(_speakerPin, note_C6,200); //C
          beep(_speakerPin, note_E6,200); //E  
...
void musical_notes::squeak() {
  for (int i=100; i<5000; i=i*1.45) {
    beep(_speakerPin,i,60);
  }
  delay(10);
  for (int i=100; i<6000; i=i*1.5) {
    beep(_speakerPin,i,20);
  }
}

void musical_notes::waka() {
  for (int i=1000; i<3000; i=i*1.05) {
    beep(_speakerPin,i,10);
  }
  delay(100);
...
void musical_notes::uhoh() {
  for (int i=1000; i<1244; i=i*1.01) {
    beep(_speakerPin,i,30);
  }
  delay(200);
